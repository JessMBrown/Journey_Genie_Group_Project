...
class TestGetWeatherByLocationFunction(unittest.TestCase):
    ...
    def test_date_valid_1_day(self):
        ...
        self.assertEqual(self.expected, GetWeatherByLocation.get_weather_by_location_and_date(self.input_data, "history"))
