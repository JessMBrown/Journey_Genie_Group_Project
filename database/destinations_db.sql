...
VALUES
    ...
    (123478, "de", "Frankfurt am Main", "museums"),
    ...
    (123582, "my", "Langkawi Island", "beaches"),
    (123583, "my", "Malacca", "history"),
    (123584, "th", "Bangkok", "museums"),
    (123585, "th", "Chiang Mai City", "history"),
    (123586, "th", "Phuket Town", "beaches"),
    (123587, "th", "Krabi City", "beaches"),
    (123588, "ph", "Manila", "museums"),
    (123589, "ph", "Cebu City", "beaches"),
    (123590, "ph", "Davao", "beaches"),
    (123591, "ph", "Iloilo", "beaches"),
    (123592, "vn", "Hanoi", "history"),
    (123593, "vn", "Ho Chi Minh", "history"),
    (123594, "vn", "Da Nang", "beaches"),
    (123595, "vn", "Nha Trang", "beaches"),
    (123596, "id", "Bali Island", "beaches"),
    ...
    (123641, "ci", "Departement de Yamoussoukro", "history"),
    ...
    (123649, "tz", "Zanzibar Island", "beaches"),
    (123650, "tz", "Arusha", "mountains"),
    (123651, "tz", "Kikuyu", "history"),
    ...
    (123670, "co", "Cartagena de Indias", "beaches"),
    ...
    (123729, "vg", "Tortola Island", "beaches"),
    (123730, "vg", "Virgin Gorda Island", "beaches"),
    (123732, "tc", "Grand Turk", "beaches"),
    (123733, "tc", "Providenciales Island", "beaches"),
    ...
    (123748, "tw", "Taipei City", "museums"),
    (123749, "tw", "Kaohsiung", "history"),
    (123750, "tw", "Taichung City", "history"),
    (123751, "tw", "Tainan City", "history"),
