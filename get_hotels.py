...
# list of filters for user to select
...
# list of hotels by the criteria and shows price
def fetch_and_sort_hotels(location_id, check_in_date, check_out_date, selected_filters, rooms, adults):
...
def main():
    while True:
        ...
        hotel_prices = fetch_and_sort_hotels(chosen_option['id'], check_in_date, check_out_date, selected_filters,
                                             rooms, adults)

        if hotel_prices:
            hotels_with_links = fetch_hotel_details_with_links(chosen_option['id'], check_in_date, check_out_date,
                                                               adults)
